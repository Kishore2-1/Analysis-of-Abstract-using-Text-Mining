...
install.packages(c("tm", "topicmodels", "reshape2", "ggplot2", "wordcloud", "pals", "SnowballC", "lda", "ldatuning", "tidyverse", "kableExtra", "DT", "flextable", "remotes", "devtools", "randomForest", "arules", "arulesViz", "cluster", "plotly")); remotes::install_github("rlesur/klippy")
...
## Visualize the distribution of popular words 
...
# K distributions over nTerms(dtm1) terms
dim(beta)    
